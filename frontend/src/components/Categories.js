    ...
    <div className='categories-container'>
      ...
      <Link to={`/Laptop`} className='categories-link-container'>
        <div className='categories-img-container'>
          <img src="/images/computing.svg" alt="categories-computing-icon" /> 
        </div>        
        <p>Laptops</p>
      </Link>
      <Link to={`/Phone`} className='categories-link-container'>
        <div className='categories-img-container'>
          <img src="/images/mobile.svg" alt="categories-computing-icon" />
        </div>
        <p>Phones</p>
      </Link>
      <Link to={`/Watch`} className='categories-link-container'>
        <div className='categories-img-container'>
          <img src="/images/smart.svg" alt="categories-computing-icon" />
        </div>
        <p>Watches</p>
      </Link>
      <Link to={`/TVs`} className='categories-link-container'>
        <div className='categories-img-container'>
          <img src="/images/tv.svg" alt="categories-computing-icon" />
        </div>
        <p>TVs</p>
      </Link> 
      <h3>Account</h3>
      <Link to={`/cart`} className='categories-link-container categories-account'>
        <div className='categories-img-container'>
          <img src="/images/shopping.svg" alt="categories-computing-icon" />
        </div>        
        <p>Basket</p>
      </Link>
      <Link to={`/orders`} className='categories-link-container categories-account'>
        <div className='categories-img-container'>
          <img src="/images/list.svg" alt="categories-computing-icon" />
        </div>
        <p>Orders</p>
      </Link>
    </div>
